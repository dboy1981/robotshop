...
module.exports = class extends think.cmswing.admin {
  ...
  async seeAction() {
    ...
    for (const val of goods) {
      var promGoods = JSON.parse(val.prom_goods);
      val.title = promGoods.title;
      val.pic = promGoods.pic;
      val.type = promGoods.type;
      val.sum = promGoods.price;
      val.days = promGoods.days;
      val.yajin = promGoods.yajin;
      val.zujin = promGoods.zujin;
